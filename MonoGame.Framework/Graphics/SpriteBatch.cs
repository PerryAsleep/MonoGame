...
namespace Microsoft.Xna.Framework.Graphics
{
	...
	public class SpriteBatch : GraphicsResource
	{
        ...
        /// <param name="sourceRectangle">An optional region on the texture which will be rendered. If null - draws full texture.</param>
        /// <param name="color">A color mask.</param>
        public void Draw(Texture2D texture, System.Drawing.RectangleF destinationRectangle, Rectangle? sourceRectangle, Color color)
        {
            CheckValid(texture);
        ...
        /// <param name="destinationRectangle">The drawing bounds on screen.</param>
        /// <param name="color">A color mask.</param>
        public void Draw(Texture2D texture, System.Drawing.RectangleF destinationRectangle, Color color)
        {
            CheckValid(texture);
